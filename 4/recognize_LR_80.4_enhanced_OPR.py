...
# base_dir = '/home/jiaheng/Desktop/GitHub/IJB-C-1/LR_deblurred_UMSN'
base_dir = '/home/jiaheng/Desktop/GitHub/IJB-C-1/LR_804_in_one_dir_enhanced_OPR/final_output'
f = open('lr_80.4.txt', 'r')
out = f.readlines()
for line in out:
    _ = line.split(' ')
    # print(_)
    ...
    video_id = _[1]
    filename = _[2][:-4] + 'png'
    img_path = (base_dir + '/' + filename).rstrip("\n")
    print(img_path)
    print("True ID:", id)
    cnt_all += 1
